...
#define SSCANF_CANNOT_HANDLE_MISSING_EXPONENT 1
...
#define MMAP_IGNORES_HINT 1
#define MMAP_ANON_IGNORES_PROTECTION 0
#define MMAP_DOESNOT_ALLOW_REMAP 1
#define ONE_SHARED_MAPPING_PER_FILEREGION_PER_PROCESS 1
#define PTHREAD_CREATE_MODIFIES_ERRNO 1
#define SEM_INIT_MODIFIES_ERRNO 1
...
#define FILE_OPS_CHECK_FERROR_OF_PREVIOUS_CALL 1
