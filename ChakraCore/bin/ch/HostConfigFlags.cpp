...
LPWSTR* HostConfigFlags::argsVal = nullptr;
int HostConfigFlags::argsCount = 0;
void(CHAKRA_CALLBACK *HostConfigFlags::pfnPrintUsage)() = nullptr;
...
void HostConfigFlags::HandleArgsFlag(int& argc, _Inout_updates_to_(argc, argc) LPWSTR argv[])
{
    ...
    HostConfigFlags::argsVal = new LPWSTR[count];
